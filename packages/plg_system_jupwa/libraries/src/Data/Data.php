...
class Data
{
    ...
    public static string $firebase_app = 'https://www.gstatic.com/firebasejs/12.14.0/firebase-app-compat.js';
    public static string $firebase_messaging = 'https://www.gstatic.com/firebasejs/12.14.0/firebase-messaging-compat.js';
