		...
		<div class="jupwa-info">
			<div>
				<div class="jupwa-header">
					<?= Text::_('PLG_JUPWA_WIDGET_HEADER') ?>
				</div>
				<div class="jupwa-subheader">
					<?= Text::_('PLG_JUPWA_WIDGET_SUBHEADER') ?>
				</div>
			</div>
