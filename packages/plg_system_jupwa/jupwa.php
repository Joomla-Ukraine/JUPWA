    ...
    public function onAfterDispatch(): void
    {
        ...
        if (Push::isPush(['params' => $this->params])) {
            $wa->registerAndUseStyle(
                'push',
                Uri::root().'media/jupwa/css/app.push.'.$this->jupwa_js_version.'.css',
                ['version' => false]
            );
            $doc->addHeadLink(
                Uri::root().'media/jupwa/css/app.push.'.$this->jupwa_js_version.'.css',
            ...
            $wa->registerAndUseScript(
                'push',
                Uri::root().'media/jupwa/js/push.'.$this->jupwa_js_version.'.js',
                ['version' => false],
                [
                    'defer' => 'defer',
                    'fetchpriority' => 'auto',
        ...
        if ($this->params->get('usepwainstall') == 1) {
            $wa->registerAndUseScript(
                'jupwa',
                Uri::root().'media/jupwa/js/jupwa.'.$this->jupwa_js_version.'.js',
                ['version' => false],
                [
                    'defer' => 'defer',
                    'fetchpriority' => 'auto',
